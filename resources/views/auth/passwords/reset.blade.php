    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Salasõna taastamine</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" onsubmit="startLoader(this)"
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Uus salasõna</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">Kinnitage uus salasõna</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    <span class="md-spinner-text">Muuda salasõna</span>
                                </button>
                            </div>
                        </div>
                    </form>
