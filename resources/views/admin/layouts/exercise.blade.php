                ...
                <div class="col-md-7 col-lg-offset-1">
                    <form method="POST" @yield('action')>
                        ...
                        <div id="ex_title-group" class="form-group label-floating short-input">
                            <label for="ex_title" class="control-label">
                                <span class="fa fa-fw fa-asterisk" aria-hidden="true"></span>
                                Ülesande pealkiri
                            </label>
                        ...
                        <div class="form-group label-floating short-input">
                            <label for="ex_author" class="control-label">
                        ...
                        <div class="form-group label-static">
                            ...
                            <input id="answer_count" class="hidden" name="answer_count"
                                   @if(isset($answers))value="{{count($answers)}}" @else value="1"@endif>
                        </div>
                        ...
                        @else
                            <button type="submit" class="btn btn-primary btn-raised">
                                <span class="spinner"><span class="md-spinner md-spinner-white"></span></span>
                                <span class="md-spinner-text">Lisa ülesanne</span>
                            </button>
                        @endif
                    </form>
                </div>
